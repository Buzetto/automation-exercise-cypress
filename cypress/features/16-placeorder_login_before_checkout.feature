Funcionalidade: Comprar os produtos do carrinho
    Como um usuário cadastrado da loja
    Quero entrar em minha conta e comprar os produtos do carrinho
    Para poder pagar e receber em casa

    Cenário: Realizar a compra completa logando antes de prosseguir com a compra
        ...
        E preencho os campos com as informações de email e senha
